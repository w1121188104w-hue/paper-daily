...
DeepSeek手动小批试译已完成并上线：10次请求无重试，新增9篇中文标题和其中8篇完整摘要，另一篇继续待翻译。现有493条记录、14篇中文标题、13篇完整中文；原有5篇中文不变。206项离线测试通过，详见[试译与上线核对](docs/deepseek-pilot-2026-09-10.md)。密钥存于GitHub Actions Secret，草稿仅加密上传、逐篇审阅后正式导入；不启用全库或每日自动翻译，不补写缺失摘要。见[DeepSeek操作说明](docs/deepseek-translation.md)。
