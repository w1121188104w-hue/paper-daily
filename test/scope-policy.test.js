...
test('历史版本兼容：按v1读取旧总名册，新写入自动采用v2，不改旧论文或引用文件', async t => {
  ...
  assert.equal(after.manifest.master_policy_version, 2); assert.equal(after.masterList.statistics.research_candidates, 0);
